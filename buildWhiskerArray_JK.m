...
Whisker.makeAllDirectory_WhiskerSignalTrial(d,'include_files',includef([50, 100, 150, 200]),'polyRoiInPix',[60-20 60+20],'follicleExtrapDistInPix',33);
Whisker.makeAllDirectory_WhiskerTrialLiteI(d,'include_files',includef([50, 100, 150, 200]),'r_in_mm',1,'calc_forces',false);
wl = Whisker.WhiskerTrialLiteArray(d);
