classdef WhiskerTrialLiteArray_2pad < handle
    %
    %
    % Modified from
    ...
    methods (Access = public)
        ...
        function obj = WhiskerTrialLiteArray_2pad(w_or_d,varargin)
            %
            %-------------
            % USAGE:
            %-------------
            ...
            if isa(p.Results.w_or_d,'Whisker.WhiskerSignalTrialArray_2pad')
...
%                         'baseline_time_end',p.Results.baseline_time_end);
            ...
            function doConstructor_directory % subfunction
                ...
                fnall = arrayfun(@(x) x.name(1:(end-12)), dir([d '*_WL_2pad.mat']),'UniformOutput',false);
                ...
                fnerror = arrayfun(@(x) x.name(1:(end-16)), dir([d '*_errorWL_2pad.mat']),'UniformOutput',false);                
