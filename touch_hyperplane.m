        ...
        for idist = 1 : length(distance_values)
            ...
            while (done_flag)
                ...
                while(strcmp(psi1_answer,'Yes'))                    
                    ...
                    title(['Angle = ', servo_values(iservo), ', Distance = ', distance_values(idist)]), xlabel('Top-view intersection coord'), ylabel('Front-view intersection coord'), zlabel('Pole position')
            ...
            %%
                ...
                while(strcmp(hp_decision,'No'))
                    ...
                    h1 = figure; plot(steps{iservo, idist},num_points(:), 'k-', 'LineWidth', 3), xlabel('translocation (pix)'), ylabel('# intersection')
                    ...
                    while(strcmp(peak_answer,'Yes'))
                        if strcmp(answer,'Yes')
                            ...
                            hp_peaks{iservo, idist} = [str2num(hp_peak_ans{1}) str2num(hp_peak_ans{2})];                    
            ...
            fprintf('%s %s trial type #%d/%d processed\n',mouseName, sessionName, (iservo-1)*idist + iservo, iservo * idist)        
        end
    end
    %%
